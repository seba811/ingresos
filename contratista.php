...
$rs_ingresos = $conexion->query("SELECT * FROM preingresos where preingresos_rut= '$rut'");
$n = $rs_ingresos->num_rows;

if($n==0){

    header("location:ingresos_nuevo_rut.php?x=no_pre");
}
...
<head>
    ...
    <title>Formulario Revision Contratista</title>
</head>
...
<body>
    ...
    <div class="container">
        <h1>Ingresos Trabajador Contratista</h1>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div>
                            <select class="form-control" name="reclutamiento" readonly id="reclutamiento">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control " id="apellidoP" name="apellidoP"  readonly value="<?= $apellidop ?>">

                        </div>
                        <div class="col">
                            <label style="color: red;">*</label><label>Apellido Materno</label>
                            <input type="text" class="form-control" id="apellidoM" name="apellidoM" readonly value="<?= $apellidom ?>">
                        </div>
                        <div class="col">
                            ...
                            -->
                            <input type="date" class="form-control" id="fecha_naci" name="fecha_naci" onchange="calcularEdad()" readonly value="<?= $nacimiento ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="fono" name="fono" readonly value="<?= $telefono ?>">
                        </div>
                        <div class="col">
                            <label style="color: red;">*</label><label>Mail</label>
                            <input type="text" class="form-control" id="correo" name="correo" readonly value="<?= $correo ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" id="direccion" name="direccion" placeholder="Direccion" readonly value="<?= $direccion ?>">
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" id="cta_banco" name="cta_banco" readonly value="<?= $cta_banco ?>">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="nombre_emerg" name="nombre_emergencia" readonly value="<?= $emergencia_nombre ?>">
                        </div>
                        <div class="col">
                            <label for="rut">Parentesco Emergencia</label>
                            <input type="text" class="form-control" id="parentesco_emerg" name="parentesco_emergencia" readonly value="<?= $emergencia_parentesco ?>">
                        </div>
                        <div class="col">
                            <label for="rut">Fono Emergencia</label>
                            <input type="text" class="form-control" id="fono_emergencia" name="fono_emergencia" readonly value="<?= $emergencia_fono ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="detalle_enfermedad" name="detalle_enfermedad"  readonly value="<?= $enfermedad_detalle ?>">
                        </div>
                        <div class="col">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="date" class="form-control" id="fecha_actual" name="fecha_ingreso" readonly value="<?= $fecha_ingreso ?>">
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="transportista_nombre" name="transportista_nombre" placeholder="Nombre Trasportista" readonly value="<?= $transportista_nombre ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="cuantas_temp" name="cuantas_temp" readonly value=<?= $temporadas ?>>
                            </div>
                        </div>

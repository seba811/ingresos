...
session_start();
   ...
   $comilla=' " ';
    ...
    while ($row = $rs_preingresos->fetch_array(MYSQLI_ASSOC)) {
        ...
        $preingresos_empresa = $row['preingresos_empresa'];
        ...
        if($preingresos_estado==1){
            ...
            $icono="width='50' height='50' class='bi bi-check-circle fa-2x ' style='font-size: 1.5rem; margin-left:10px;color: green'";
        }else if($preingresos_estado==2 ){

          $icono="width='50' height='50' class='bi bi-check-circle-fill fa-2x ' style='font-size: 1.5rem; margin-left:10px;color: blue'";
      }else if($preingresos_estado==3 ){

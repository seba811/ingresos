...
$reclutamiento_tipo=trim($_POST['reclutamiento_tipo']);
$reclutamiento_nombre=trim($_POST['reclutamiento_nombre']);
// Traigo la empresa
$empresa=trim($_POST['empresa']);
$comoinforma= trim($_POST['comoinforma']);
//MODULO 1
$fecha_ingreso = trim($_POST['fecha_ingreso']);
$cargo = trim($_POST['cargo']);
$transportista = trim($_POST['transportista']);
$trasnportista_nombre = trim($_POST['transportista_nombre']);
...
$faena1=trim($row['codigos_nombre']);
$faena2=trim($row['codigos_descripcion']);
...
$observaciones1 = trim($_POST['observaciones']);
...
$fono_emergencia = trim($_POST['fono_emergencia']);
...
$enfermedad_detalle = trim($_POST['detalle_enfermedad']);

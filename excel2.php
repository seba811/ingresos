...
$borders = array(
    ...
    ->applyFromArray($borders);
     ...
     $rs_preingresos = $conexion->query("SELECT * FROM preingresos where preingresos_fecha_ingreso = '$fecha_filtro' and (preingresos_estado=0 or preingresos_estado=3) and preingresos_empresa='$empresa_ficha'");
     $cont=0;
...
if($tiporeclutador==0){
    ...
    $tiporeclutadornom='PLANTA';
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                 ...
                 ->setCellValue('P'.$y, 'Natura Requinoa')

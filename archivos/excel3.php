...
$borders = array(
    ...
    ->applyFromArray($borders);
     ...
     $rs_ingresos = $conexion->query("SELECT * FROM ingresos where ingresos_id=$ids2[$i]");
...
->applyFromArray($borders);
 ...
 //--------------------------------------------------------------------------------
     ...
     $objPHPExcel->setActiveSheetIndex(0);
     $nombre="Content-Disposition: attachment;filename=Ficha Contratacion individual-".$hoy.".xlsx";

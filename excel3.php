...
FROM bd_contratacion.preingresos as a left join bd_contratacion.tipo_reclutamiento as b on a.preingresos_reclutador_nombre = b.tipo_reclutamiento_razon_social
where a.preingresos_fecha_ingreso = '$fecha_filtro' and a.preingresos_tipo_reclutador='0' and a.preingresos_estado='2'");
$cont = 0;
